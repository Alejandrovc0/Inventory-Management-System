...
2. Set up the MySQL database:
    ...
    - You can use a MySQL database management tool like MySQL Workbench, or the MySQL command line interface to execute the script. Save the [script](script_database.sql) to a file, e.g., setup_database.sql.
